export const BattlePokedex: {[speciesid: string]: SpeciesData} = {
	...
	victreebelhoundoom: {
		num: 11136,
		name: "victreebelhoundoom",
		types: ["Grass", "Fire"],
		baseStats: {hp: 78, atk: 95, def: 55, spa: 103, spd: 73, spe: 86},
		abilities: {0: "Chlorophyll", 1: "Flash Fire", H: "Gluttony"},
		heightm: 1.5499999999999998,
		weightkg: 25.25,
		color: "Green",
		eggGroups: ["Field", "Grass"],
	...
	vileplumehoundoom: {
		num: 11137,
		name: "vileplumehoundoom",
		types: ["Grass", "Fire"],
		baseStats: {hp: 75, atk: 86, def: 61, spa: 110, spd: 86, spe: 80},
		abilities: {0: "Chlorophyll", 1: "Flash Fire", H: "Effect Spore"},
		heightm: 1.2999999999999998,
		weightkg: 26.8,
		color: "Red",
		eggGroups: ["Field", "Grass"],
	...
	omastargengar: {
		...
		name: "omastargengar",
		types: ["Water", "Ghost"],
		baseStats: {hp: 66, atk: 63, def: 81, spa: 120, spd: 71, spe: 91},
		abilities: {0: "Swift Swim", 1: "Cursed Body", H: "Weak Armor"},
		heightm: 1.25,
		weightkg: 37.75,
		color: "Blue",
		eggGroups: ["Amorphous", "Water 1"],
