 ...
 const Abilities = {
	...
	tangledfeet: {
		...
		onModifyAccuracy(accuracy, target) {
			if (typeof accuracy !== 'number') return;
			if (_optionalChain([target, 'optionalAccess', _16 => _16.volatiles, 'access', _17 => _17['confusion']])) {
	...
	triage: {
		onModifyPriority(priority, pokemon, target, move) {
			if (_optionalChain([move, 'optionalAccess', _18 => _18.flags, 'access', _19 => _19['heal']])) return priority + 3;
		},
		name: "Triage",
		rating: 3.5,
		num: 205,
